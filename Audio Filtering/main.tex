...
Below code plots \figref{fig:dft__} $y(n)$ using DFT:
\begin{lstlisting}
...
Below code plots \figref{fig:fft__} $y(n)$ using FFT:
\begin{lstlisting}
https://github.com/Avyaaz13/Audio-Filtering/blob/main/Audio%20Filtering/codes/6.4_ynfft.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{figs/6.2_fft.png}
\caption{$y(n)$ obtained from FFT}
\label{fig:fft__}
\end{figure}
