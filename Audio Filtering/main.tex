...
\author{EE23BTECH11013 - Chedurtipati Avyaaz$^{*}$% <-this % stops a space
}
\maketitle
\newpage
\bigskip
...
\lstinputlisting{./codes/noise_red.py}\label{py:audio_filter}
...
\begin{lstlisting}
https://github.cm/Avyaaz13/Audio-Filtering/blob/main/Audio%20Filtering/codes/xnyn.c
\end{lstlisting} 
...
%
\\
\solution Below code plots Fig. \ref{fig:ynconv}. Note that this is the same as 
$y(n)$ in  Fig. 
\ref{fig:xnyn}. 
%
\begin{lstlisting}
...
\begin{lstlisting}
https://github.com/Avyaaz13/Audio-Filtering/blob/main/Audio%20Filtering/codes/IFFT_IDFT.py 
\end{lstlisting}
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{figs/yn_ver.png}
\caption{$y(n)$ obtained from IFFT}
