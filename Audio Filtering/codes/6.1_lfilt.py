...
plt.stem(output_signal_scipy[range_of_interest], linefmt='c', markerfmt='go', basefmt='k', label='Scipy lfilter')
plt.stem(output_signal_custom[range_of_interest], linefmt='m', markerfmt='ro', basefmt='k', label='Custom lfilter')
plt.legend()
plt.grid(True)
plt.savefig('lfilt.png')
plt.show()
